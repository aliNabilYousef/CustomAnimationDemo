...
class LPDWAnimator: NSObject {
    
    // MARK: - Public Properties
    public var duration: TimeInterval = 2.0
    public weak var label: LPAnimatedLabel? {
        didSet {
    ...
    private(set) var animationType: LPAnimationType
    ...
    // MARK: - Init
    convenience init(animationType: LPAnimationType, duration:TimeInterval) {
        self.init()
